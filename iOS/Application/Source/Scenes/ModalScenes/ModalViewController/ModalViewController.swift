...
class ModalViewController: UIViewController {
    ...
    let viewModel: ModalViewViewModel
    
    init<T: UIViewController>(childViewController: T, viewModel: ModalViewViewModel) where T: ModalDisplayable {
    ...
    private func addConstraints() {
        ...
        let maxHeight = scrollView.heightAnchor.constraint(
            lessThanOrEqualTo: view.heightAnchor, constant: -headerHeight
        )
